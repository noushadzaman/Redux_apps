...
import { deleteBooks } from "../redux/books/thunk/deleteBook";

const BookCard = ({ book, setEditingBook }) => {
    const dispatch = useDispatch();
    const { featured, name, author, thumbnail, price, rating, id } = book;
            ...
            <div className="flex-1 h-full pr-2 pt-2 flex flex-col">
                ...
                <div className="space-y-2 mt-4 h-full">
                    ...
                    <div className="lws-stars">
                        {
                            Array(rating).fill(0).map((r, idx) => <svg
                                key={idx}
                                viewBox="0 0 20 20" fill="currentColor" className="lws-star">
